report 50702 "Mcd Sales Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/layout/McdSalesOrder.rdl';
    Caption = 'SSI Sales Order';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(ShippingAgentServiceValue; "Sales Header"."Shipping Agent Service Code")
                    {
                    }
                    column(ShippingNoteValue; "Sales Header".McdShippingNote)
                    {
                    }
                    ...
                    column(ShippingNoteCaption; ShippingNoteLbl)
                    {
    ...
    begin
        ...
        ShipDateCaptionLbl := 'SHIP DATE';
    end;

    protected var
        Item: Record item;
        TenantMedia: Record "Tenant Media";
        ShipDateCaptionLbl: Text; // Label 'SHIP DATE';
        ...
        ShippingNoteLbl: Label 'SHIPPING NOTE';
